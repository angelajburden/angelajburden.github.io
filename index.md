...
This webpage describes the process and code that creates a neural network that can distinguish between quasars and point-like objects (92% accuracy) using only their photometric properties.
