...
![alt text](/images/NNetwork_fig.jpg){:height="30%" width="30%"}

<p style="font-size:larger;color:black;margin-left: -20px;"> The neural network is set up as shown in the figure above.</p>
