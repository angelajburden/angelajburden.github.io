...
<p style="color:FireBrick;font-weight:bold;"> UPDATE: I found that it was more efficient to use the sklearn.neural_network.MLPClassifier. The new code has been added to the repo, and I will be updating the results section.</p>
